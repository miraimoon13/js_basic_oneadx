console.log(`Viết chương trình cho phép người dùng nhập vào 5 mã số, lưu 5 mã số này vào một mảng.
...
console.log(`Chuoi vua nhap la: ${chuoi}`);

let regex = /^00*\d[2-5]*L*\d{0,4}$/;
